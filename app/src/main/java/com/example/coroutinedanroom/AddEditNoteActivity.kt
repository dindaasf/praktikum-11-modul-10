package com.example.coroutinedanroom
...
class AddEditNoteActivity  : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            //edit_text_notelp.setText(intent.getStringExtra(EXTRA_NOMER))
    ...
    private fun saveNote() {
        ...
        {//|| edit_text_notelp.text.toString().trim().isBlank()) {
        ...
        val data = Intent().apply {
            ...
            //putExtra(EXTRA_NOMER, edit_text_notelp.text.toString())
